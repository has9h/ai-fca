...
# Beleif network report-of-leaving example (Example 8.15 shown in Figure 8.3) of
...
class InferenceMethod(Displayable):
    ...
    def testIM(self, threshold=0.0000000001):
        ...
        assert correct_answer-threshold < res[True] < correct_answer+threshold, f"value {res[True]} not in desired range for {self.method_name}"
