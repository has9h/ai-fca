...
class Searcher(Displayable):
    ...
    def __init__(self, problem):
        ...
        self.num_expanded = 0   # not entirely clear what this is for
        self.explored = set()
...
class AStarSearcher(Searcher):
    ...
    def add_to_explored(self, path):
        """avoid backtracking of already visited nodes.
        """
        self.explored.add(path.start())


import searchProblem as searchProblem

def test(SearchClass, problem=searchProblem.assignment_1, solutions=[['i','h','f','c','a']] ):
...
# example queries:
# searcher1 = AStarSearcher(searchProblem.problem1)   # DFS
